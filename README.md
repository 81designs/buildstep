...
Heroku-style application builds using Docker and Buildpacks. Used by [Dokku](https://github.com/81designs/dokku) to make a mini-Heroku.
...
This will create a container called `81designs/buildstep` that contains all supported buildpacks and the
...
an argument. It will put the application in a new container based on `81designs/buildstep` with the specified name. 
